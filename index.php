...
<html lang="en">
  ...
  <body>
    ...
    <div id="layout">
      ...
      <div class="hero-header">
        ...
        <div id="hero-slider" class="hero-slider">
          <!-- Item Slide-->
          <div class="item-slider" style="background: url(images/3.jpg)">
            <div class="container">
              <div class="row align-items-center">
                <div class="col-lg-7">
                  <div class="info-slider">
                    ...
                    <p>
                      While familiar with fellow European nation France, Hareide
                      admits that South American side Peru.
                    </p>
                    <a href="#" class="btn-iw outline"
          ...
          <!-- Item Slide-->
          <div class="item-slider" style="background: url(images/2.jpg)">
            <div class="container">
              <div class="row align-items-center">
                <div class="col-lg-7">
                  <div class="info-slider">
          ...
          <!-- Item Slide-->
          <div class="item-slider" style="background: url(images/1.jpg)">
            <div class="container">
              <div class="row align-items-center">
                <div class="col-lg-7">
                  <div class="info-slider">
      ...
      <section class="content-info">
                          ...
                          <div class="info-results">
                            <ul>
                              ...
                              <li>
                                <span class="head">
                                  Uruguay Vs Portugal
                                  <span class="date">31 Jun 2017</span>
                                </span>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          ...
                          <p class="lead">
                            ...
                            Cup, a quadrennial international football tournament
                            contested by the men's national teams. West of the
                            Ural Mountains to keep travel time manageable.
                          </p>
                        </div>

                        <div class="col-md-12">
                          <p>
                            It is scheduled to take place in Russia from 14 June
                            to 15 July 2018,[2] after the country was awarded
                            the hosting rights on 2 December 2010. This will be
                            the first World Cup held in Europe since 2006; all
                            but one of the stadium venues are in European
                            Russia, west of the Ural Mountains to keep travel
                            time manageable.
                          </p>
        ...
        <div class="container padding-top">
          <div class="row">
              ...
              <div class="panel-box">
                ...
                <div class="post-item">
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <h5>
                        <a href="single-news.html">Group Stage Breakdown</a>
                      </h5>
                      <span class="data-info"
                        >January 3, 2014 / <i class="fa fa-comments"></i
                        ><a href="#">0</a></span
                      >
                      <p>
                        While familiar with fellow European nation France,
                        Hareide admits that South American side Peru.<a
                    ...
                    <div class="col-md-8">
                      <h5>
                        <a href="single-news.html"
                          >All set for your trip to Russia?</a
                        >
                      </h5>
                      <span class="data-info"
                        >January 8, 2014 / <i class="fa fa-comments"></i
                        ><a href="#">2</a></span
                      >
                      <p>
                        Colombia play Japan on 19 June at the Mordovia Arena,
                        where the piling and casting operations.<a
                          href="single-news.html"
                          >Read More [+]</a
                        >
                      </p>
            ...
            <!-- End content Left -->
            <aside class="col-sm-6 col-lg-5 col-xl-5">
              <!-- Experts -->
              <div class="panel-box">
                <div class="titles">
                  <h4>Best Players</h4>
                ...
                <div class="row">
                  <div class="col-xs-4 col-sm-3 col-md-4 col-lg-4">
                    <div class="box-info">
                      ...
                      <h6 class="entry-title">
                        <a href="single-player.html">Cristiano Ronaldo</a>
                      </h6>
                    </div>
                  </div>
                  <div class="col-xs-6 col-sm-3 col-md-4 col-lg-4">
                    <div class="box-info">
                      ...
                      <h6 class="entry-title">
                        <a href="single-player.html">Lionel Messi</a>
                      </h6>
                    </div>
                  </div>
                  <div class="col-xs-6 col-sm-3 col-md-4 col-lg-4">
                    <div class="box-info">
                      ...
                      <h6 class="entry-title">
                        <a href="single-player.html">Neymar</a>
                      </h6>
                    </div>
                  </div>
                  <div class="col-xs-6 col-sm-3 col-md-4 col-lg-4">
                    <div class="box-info">
                      ...
                      <h6 class="entry-title">
                        <a href="single-player.html">Luis Suárez</a>
                      </h6>
                    </div>
                  </div>
                  <div class="col-xs-6 col-sm-3 col-md-4 col-lg-4">
                    <div class="box-info">
                      ...
                      <h6 class="entry-title">
                        <a href="single-player.html"> Gareth Bale</a>
                      </h6>
                    </div>
                  </div>
                  <div class="col-xs-6 col-sm-3 col-md-4 col-lg-4">
                  ...
                  <div class="col-xs-6 col-sm-3 col-md-4 col-lg-4">
                    <div class="box-info">
                      ...
                      <h6 class="entry-title">
                        <a href="single-player.html">Sergio Agüero</a>
                      </h6>
                    </div>
                  </div>
                  <div class="col-xs-6 col-sm-3 col-md-4 col-lg-4">
    ...
    <!-- jQuery local-->
    <script
      type="23716e3258438f5422e24ea5-text/javascript"
      src="js/jquery.js"
    ></script>
    <!-- popper.js-->
    <script
    ...
    <script
      ...
      data-cf-settings="23716e3258438f5422e24ea5-|49"
      defer=""
    ></script>
