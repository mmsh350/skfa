...
<head>
    ...
    <body>
      ...
      <!-- End Mobile Nav-->
            ...
            <!-- Section Title -->
            <div class="section-title single-player" style="background:url(images/3.jpg)">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            <h1>Single Player</h1>
                            ...
                            <div class="col-lg-4 col-xl-3">
                                ...
                                <div class="item-player single-player">
                                    <div class="head-player">
                                        <img src="images/7.jpg" alt="location-team">
                                    </div>
                                    <div class="info-player">
                                        ...
                                        <ul>
                                            <li>
                                                <strong>CLUB NAME:</strong> <span><img src="images/colombia.png" alt=""> Colombia </span>
                                          ...
                                          <div class="titles">
                                            ...
                                            <div class="row">
                                               <div class="col-lg-12 col-xl-4">
                                                   <img src="images/single-team.jpg" alt="">
                                               </div>
                                            ...
                                            <table class="table-striped table-responsive table-hover career">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="images/colombia.png" alt="icon1">
                                                            Japan
                                                        </td>
                                                        <td>22(0)</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="images/japan.png" alt="icon1">
                                                            Japan
                                                        </td>
                                                        <td>22(0)</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="images/bra.png" alt="icon1">
                                                            Japan
                                                        </td>
                                                        <td>22(0)</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="images/arg.png" alt="icon1">
                                                            Japan
                                                        </td>
                                                        <td>22(0)</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="images/uru.png" alt="icon1">
                                                            Japan
                                                        </td>
                                                        <td>22(0)</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="images/nga.png" alt="icon1">
                                                            Japan
                                                        </td>
                                                        <td>22(0)</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="images/mex.png" alt="icon1">
                                                            Japan
                                                        </td>
                                                        <td>22(0)</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="images/rusia.png" alt="icon1">
                                                            Japan
                                                        </td>
                                                        <td>22(0)</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="images/aus.png" alt="icon1">
                                                            Japan
                                                        </td>
                                                        <td>22(0)</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="images/arabia.png" alt="icon1">
                                                            Japan
                                                        </td>
                                                        <td>22(0)</td>
                                                        <td>
 ...
 <!-- footer-->
      ...
      <div id="site-copyright" class="footer-down"></div>
        ...
        <!-- ======================= JQuery libs =========================== -->
        <!-- jQuery local-->
        <script type="1f91827d586ac532c8d31ed8-text/javascript" src="js/jquery.js"></script>
        <!-- popper.js-->
        <script type="1f91827d586ac532c8d31ed8-text/javascript" src="js/popper.min.js"></script>
        <!-- bootstrap.min.js-->
        <script type="1f91827d586ac532c8d31ed8-text/javascript" src="js/bootstrap.min.js"></script>
        <!-- required-scripts.js-->
        <script type="1f91827d586ac532c8d31ed8-text/javascript" src="js/theme-scripts.js"></script>
        <!-- theme-main.js-->
        <script type="1f91827d586ac532c8d31ed8-text/javascript" src="js/theme-main.js"></script>
        <!-- ======================= End JQuery libs =========================== -->

    <script src="js/rocket-loader.min.js" data-cf-settings="1f91827d586ac532c8d31ed8-|49" defer=""></script>
